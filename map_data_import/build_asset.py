...
def main():
    ...
    try:
        botw_import_addon.operators.botw_asset_import.constants.ensure_caches(shared_mem_name="BOTW_ASSET_CACHE")
        botw_import_addon.operators.botw_asset_import.import_and_process_dae(context, dae_path)
